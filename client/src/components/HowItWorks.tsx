    ...
    mockup: (
      <div className="bg-gray-50 rounded-lg p-4 text-left">
        <div className="flex items-center space-x-2 mb-3">
          ...
          <span className="text-xs text-gray-500 ml-2">solution.py</span>
        </div>
        <div className="text-xs text-green-700 font-mono">def binary_search(arr, target):</div>
        <div className="text-xs text-gray-700 font-mono ml-4">left, right = 0, len(arr) - 1</div>
        <div className="text-xs text-gray-700 font-mono ml-4">while left &lt;= right:</div>
        <div className="text-xs text-blue-700 font-mono ml-8"># Your code here</div>
        <div className="mt-2 flex items-center space-x-2">
          <div className="w-2 h-2 bg-green-500 rounded-full"></div>
          <span className="text-xs text-green-700">Tests passing: 3/5</span>
        </div>
      </div>
    )
  },
